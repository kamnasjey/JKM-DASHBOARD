...
export const DETECTOR_PRESETS: DetectorPreset[] = [
  ...
  {
    id: "USDCHF",
    nameEn: "USDCHF - Mean Reversion",
    nameMn: "USDCHF - Mean Reversion",
    descEn: "15m Mean Reversion strategy optimized for USDCHF.",
    descriptionMn: "USDCHF-д зориулсан 15m Mean Reversion стратеги.",
    detectors: ["GATE_REGIME", "MEAN_REVERSION_SNAPBACK", "PINBAR_AT_LEVEL"],
    icon: "🇨🇭",
    recommendedSettings: {
      minRR: 2.5,
  ...
  {
    id: "EURCHF",
    nameEn: "EURCHF - Mean Reversion",
    nameMn: "EURCHF - Mean Reversion",
    descEn: "15m Mean Reversion strategy optimized for EURCHF.",
    descriptionMn: "EURCHF-д зориулсан 15m Mean Reversion стратеги.",
    detectors: ["GATE_REGIME", "MEAN_REVERSION_SNAPBACK", "PINBAR_AT_LEVEL"],
    icon: "🇨🇭",
    recommendedSettings: {
      minRR: 2.5,
