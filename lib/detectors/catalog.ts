...
export const DETECTOR_PRESETS: DetectorPreset[] = [
  // ============================================================
  // 15 Symbol-Based Strategy Presets (Optimized for 50%+ Winrate, RR 2.7)
  // ============================================================
  {
    id: "EURUSD",
    nameEn: "EURUSD",
    nameMn: "EURUSD",
    descEn: "Momentum Continuation + Trend Fibo strategy optimized for EURUSD.",
    descriptionMn: "EURUSD-д зориулсан Momentum + Trend Fibo стратеги.",
    detectors: ["GATE_REGIME", "MOMENTUM_CONTINUATION", "TREND_FIBO"],
    icon: "🇪🇺",
    recommendedSettings: {
      minRR: 2.7,
      symbols: ["EURUSD"],
  ...
  },
  {
    ...
    nameEn: "USDJPY",
    nameMn: "USDJPY",
    descEn: "Momentum Continuation + Trend Fibo strategy optimized for USDJPY.",
    descriptionMn: "USDJPY-д зориулсан Momentum + Trend Fibo стратеги.",
    detectors: ["GATE_REGIME", "MOMENTUM_CONTINUATION", "TREND_FIBO"],
    icon: "🇯🇵",
    recommendedSettings: {
      minRR: 2.7,
  ...
  },
  {
    ...
    nameEn: "GBPUSD",
    nameMn: "GBPUSD",
    descEn: "BOS + CHOCH structure strategy optimized for GBPUSD.",
    descriptionMn: "GBPUSD-д зориулсан BOS + CHOCH бүтцийн стратеги.",
    detectors: ["GATE_REGIME", "BOS", "CHOCH"],
    icon: "🇬🇧",
    recommendedSettings: {
      minRR: 2.7,
      symbols: ["GBPUSD"],
  ...
  },
  {
    ...
    nameEn: "AUDUSD",
    nameMn: "AUDUSD",
    descEn: "Fakeout Trap + CHOCH reversal strategy optimized for AUDUSD.",
    descriptionMn: "AUDUSD-д зориулсан Fakeout + CHOCH эргэлтийн стратеги.",
    detectors: ["GATE_REGIME", "FAKEOUT_TRAP", "CHOCH"],
    icon: "🇦🇺",
    recommendedSettings: {
      minRR: 2.7,
      symbols: ["AUDUSD"],
  ...
  },
  {
    ...
    nameEn: "USDCAD",
    nameMn: "USDCAD",
    descEn: "Momentum Continuation + Trend Fibo strategy optimized for USDCAD.",
    descriptionMn: "USDCAD-д зориулсан Momentum + Trend Fibo стратеги.",
    detectors: ["GATE_REGIME", "MOMENTUM_CONTINUATION", "TREND_FIBO"],
    icon: "🇨🇦",
    recommendedSettings: {
      minRR: 2.7,
  ...
  },
  {
    ...
    nameEn: "USDCHF",
    nameMn: "USDCHF",
    descEn: "Fakeout Trap + CHOCH reversal strategy optimized for USDCHF.",
    descriptionMn: "USDCHF-д зориулсан Fakeout + CHOCH эргэлтийн стратеги.",
    detectors: ["GATE_REGIME", "FAKEOUT_TRAP", "CHOCH"],
    icon: "🇨🇭",
    recommendedSettings: {
      minRR: 2.7,
  ...
  },
  {
    ...
    nameEn: "NZDUSD",
    nameMn: "NZDUSD",
    descEn: "Trend Fibo strategy optimized for NZDUSD.",
    descriptionMn: "NZDUSD-д зориулсан Trend Fibo стратеги.",
    detectors: ["GATE_REGIME", "TREND_FIBO"],
    icon: "🇳🇿",
    recommendedSettings: {
      minRR: 2.7,
      symbols: ["NZDUSD"],
  ...
  },
  {
    ...
    nameEn: "EURJPY",
    nameMn: "EURJPY",
    descEn: "Momentum Continuation + Trend Fibo strategy optimized for EURJPY.",
    descriptionMn: "EURJPY-д зориулсан Momentum + Trend Fibo стратеги.",
    detectors: ["GATE_REGIME", "MOMENTUM_CONTINUATION", "TREND_FIBO"],
    icon: "💶",
    recommendedSettings: {
      minRR: 2.7,
  ...
  },
  {
    ...
    nameEn: "GBPJPY",
    nameMn: "GBPJPY",
    descEn: "Sweep + BOS liquidity strategy optimized for GBPJPY.",
    descriptionMn: "GBPJPY-д зориулсан Sweep + BOS liquidity стратеги.",
    detectors: ["GATE_REGIME", "SWEEP", "BOS"],
    icon: "💷",
    recommendedSettings: {
      minRR: 2.7,
      symbols: ["GBPJPY"],
  ...
  },
  {
    ...
    nameEn: "EURGBP",
    nameMn: "EURGBP",
    descEn: "Fakeout Trap + CHOCH reversal strategy optimized for EURGBP.",
    descriptionMn: "EURGBP-д зориулсан Fakeout + CHOCH эргэлтийн стратеги.",
    detectors: ["GATE_REGIME", "FAKEOUT_TRAP", "CHOCH"],
    icon: "🇪🇺",
    recommendedSettings: {
      minRR: 2.7,
  ...
  },
  {
    ...
    nameEn: "AUDJPY",
    nameMn: "AUDJPY",
    descEn: "CHOCH + SFP reversal strategy optimized for AUDJPY.",
    descriptionMn: "AUDJPY-д зориулсан CHOCH + SFP эргэлтийн стратеги.",
    detectors: ["GATE_REGIME", "CHOCH", "SFP"],
    icon: "🇦🇺",
    recommendedSettings: {
      minRR: 2.7,
      symbols: ["AUDJPY"],
  ...
  },
  {
    ...
    nameEn: "EURAUD",
    nameMn: "EURAUD",
    descEn: "Fakeout Trap + CHOCH reversal strategy optimized for EURAUD.",
    descriptionMn: "EURAUD-д зориулсан Fakeout + CHOCH эргэлтийн стратеги.",
    detectors: ["GATE_REGIME", "FAKEOUT_TRAP", "CHOCH"],
    icon: "🇪🇺",
    recommendedSettings: {
      minRR: 2.7,
  ...
  },
  {
    ...
    nameEn: "EURCHF",
    nameMn: "EURCHF",
    descEn: "Trend Fibo strategy optimized for EURCHF.",
    descriptionMn: "EURCHF-д зориулсан Trend Fibo стратеги.",
    detectors: ["GATE_REGIME", "TREND_FIBO"],
    icon: "🇨🇭",
    recommendedSettings: {
      minRR: 2.7,
  ...
  },
  {
    ...
    nameEn: "XAUUSD",
    nameMn: "XAUUSD (Алт)",
    descEn: "BOS + CHOCH structure strategy optimized for Gold.",
    descriptionMn: "Алтанд зориулсан BOS + CHOCH бүтцийн стратеги.",
    detectors: ["GATE_REGIME", "BOS", "CHOCH"],
    icon: "🥇",
    recommendedSettings: {
      minRR: 2.7,
  ...
  },
  {
    id: "BTCUSD",
    nameEn: "BTCUSD",
    nameMn: "BTCUSD (Bitcoin)",
    descEn: "Fakeout Trap + CHOCH reversal strategy optimized for Bitcoin.",
    descriptionMn: "Bitcoin-д зориулсан Fakeout + CHOCH эргэлтийн стратеги.",
    detectors: ["GATE_REGIME", "FAKEOUT_TRAP", "CHOCH"],
    icon: "₿",
    recommendedSettings: {
      minRR: 2.7,
