...
export const DETECTOR_PRESETS: DetectorPreset[] = [
  // ============================================================
  // 5 Data-Driven Strategy Presets (25-day Backtest Verified)
  // Last updated: 2026-02-08
  // ============================================================
  {
    id: "smc_trend",
    nameEn: "SMC Trend Following",
    nameMn: "SMC Trend Following",
    descEn: "BOS + OB based trend strategy. Best backtest result: 50% WR, +35R. Works in trending markets.",
    descriptionMn: "BOS + OB дээр суурилсан trend стратеги. Backtest: 50% WR, +35R. Trend зах зээлд ажиллана.",
    detectors: ["BOS", "CHOCH", "OB", "SR_BOUNCE", "ENGULF_AT_LEVEL", "PINBAR_AT_LEVEL"],
    icon: "📈",
    recommendedSettings: {
      minRR: 2.5,
  ...
  },
  {
    ...
    nameEn: "Range Bounce",
    nameMn: "Range Bounce",
    descEn: "SR bounce + fakeout trap for ranging markets. Selective entry with min_score 0.6.",
    descriptionMn: "Range горимд SR bounce, fakeout trap ашиглан арилжаалах. Сонгомол (min_score 0.6).",
    detectors: ["SR_BOUNCE", "FAKEOUT_TRAP", "RECTANGLE_RANGE_EDGE", "SWEEP", "SFP", "ENGULF_AT_LEVEL", "PINBAR_AT_LEVEL"],
    icon: "📊",
    recommendedSettings: {
      minRR: 2.5,
      symbols: ["EURUSD", "EURGBP", "USDCHF", "EURCHF", "AUDNZD"],
      timeframes: ["15m", "1h"],
    },
    style: "range",
  ...
  },
  {
    ...
    nameMn: "Breakout Momentum",
    descEn: "Momentum continuation + breakout retest. Enter at trend start. Top detector: MOMENTUM (47% WR, +8R).",
    descriptionMn: "Momentum continuation + breakout retest. Trend эхлэлд оролцох. MOMENTUM 47% WR, +8R.",
    detectors: ["BREAKOUT_RETEST_ENTRY", "SR_BREAK_CLOSE", "TRIANGLE_BREAKOUT_CLOSE", "FLAG_PENNANT", "MOMENTUM_CONTINUATION"],
    icon: "🚀",
    recommendedSettings: {
      minRR: 2.5,
      symbols: ["GBPUSD", "GBPJPY", "XAUUSD", "EURJPY", "BTCUSD"],
      timeframes: ["15m", "1h"],
    },
    style: "breakout",
    difficulty: "intermediate",
  ...
  {
    id: "reversal_transition",
    nameEn: "Reversal Transition",
    nameMn: "Reversal Transition",
    descEn: "CHOCH + double top/bottom for trend reversals. Very selective: min_rr 3.5, TRANSITION regime only.",
    descriptionMn: "CHOCH + double top/bottom ашиглан чиглэл өөрчлөлт олох. Маш сонгомол: min_rr 3.5.",
    detectors: ["CHOCH", "SFP", "DOUBLE_TOP_BOTTOM", "HEAD_SHOULDERS", "SR_BOUNCE", "ENGULF_AT_LEVEL", "PINBAR_AT_LEVEL"],
    icon: "🔄",
    recommendedSettings: {
      minRR: 3.5,
  ...
  },
  {
    ...
    nameEn: "All Weather",
    nameMn: "All Weather",
    descEn: "Universal strategy for all market conditions. 18 detectors with data-driven weights. BOS & MOMENTUM boosted.",
    descriptionMn: "Бүх горимд ажиллах universal стратеги. 18 detector, data-driven weights. BOS & MOMENTUM өндөр жинтэй.",
    detectors: ["BOS", "MOMENTUM_CONTINUATION", "CHOCH", "OB", "SR_BOUNCE", "SR_BREAK_CLOSE", "FIBO_RETRACE_CONFLUENCE", "BREAKOUT_RETEST_ENTRY", "TRIANGLE_BREAKOUT_CLOSE", "SFP", "SWEEP", "FAKEOUT_TRAP", "RECTANGLE_RANGE_EDGE", "FLAG_PENNANT", "ENGULF_AT_LEVEL", "PINBAR_AT_LEVEL", "DOUBLE_TOP_BOTTOM", "HEAD_SHOULDERS"],
    icon: "🌐",
    recommendedSettings: {
      minRR: 2.5,
