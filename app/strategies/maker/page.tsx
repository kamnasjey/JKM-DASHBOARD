      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">Strategy Maker</h1>
              <p className="text-sm text-muted-foreground">AI + detector selection</p>
            </div>
          </div>
          <Button variant="outline" onClick={() => router.push("/strategies")}>Стратегиуд руу</Button>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Left: AI Chat */}
          <div className="rounded-2xl border bg-card flex flex-col h-[calc(100vh-220px)] min-h-[520px]">
          ...
          <div className="space-y-4">
            ...
            >
              <div className="flex items-center justify-between flex-wrap gap-3">
                <div className="flex items-center gap-2">
                  {isValid ? <Check className="h-5 w-5 text-green-500" /> : <AlertTriangle className="h-5 w-5 text-yellow-500" />}
            ...
            <div className="rounded-2xl border bg-card p-4 max-h-[calc(100vh-440px)] overflow-y-auto">
