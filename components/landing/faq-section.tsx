  ...
  const faqs = [
    {
      ...
      a: "Гуравдагч эх сурвалжаас 5 минут тутам тасралтгүй татаж, өөрсдийн серверт хадгалдаг. Энэ нь жинхэнэ зах зээлийн дата бөгөөд 15+ Forex хос + XAUUSD, BTCUSD зэрэг дэмждэг.",
    },
    {
